        ...
        $(document).ready(function() {
            ...
            table = $('#dataTable').DataTable( DataTable.dataTableConfig('${moduleName}',[
                ...
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        $('#financeModal').modal();
                        window.open('${rc.contextPath}/financeCustomer/list?mode=simple','targetWindow');
                    }
                }
                ,{
                    extend: "create",
                    text: "查看未关联财务客户",
                    action: function ( e, dt, node, config ) {
                        window.open('${rc.contextPath}/baseCustomer/list?unifiedId=&nullable=true','_self');
                    }
                }
                ,{
                    extend: "create",
                    text: "查看已关联财务客户",
                    action: function ( e, dt, node, config ) {
                        window.open('${rc.contextPath}/baseCustomer/list?unifiedId=&nullable=false','_self');
                    }
                }
